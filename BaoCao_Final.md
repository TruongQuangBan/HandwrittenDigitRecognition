...
### 3.4.3. Endpoint `POST /predict_base64`
...
### 3.4.4. Kiểm tra dữ liệu đầu vào
...
# Chương 4: Triển khai Docker

## 4.1. Lý do sử dụng Docker
...
## 4.4. Build và chạy ứng dụng bằng Docker
...
Link GitHub: https://github.com/TruongQuangBan/HandwrittenDigitRecognition.git

# Demo

Docker image: https://hub.docker.com/r/kuteoskando2004/handwritten-recognition
